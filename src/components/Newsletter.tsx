...
export function Newsletter() {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-stone-900 via-stone-800 to-stone-900 relative overflow-hidden">
      {/* Decorative Elements */}
      <div className="absolute top-0 left-0 w-96 h-96 bg-amber-600/10 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2" />
                ...
                {!isSubscribed ? (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      <div>
                        <Input
                          ...
                          className="bg-white/10 border-white/20 text-white placeholder:text-stone-500 h-14 rounded-xl focus:border-amber-500 focus:ring-amber-500"
                        />
                      </div>
                      <Button
                        type="submit"
                        disabled={isSubmitting}
                        className="w-full h-14 bg-gradient-to-r from-amber-600 to-amber-700 hover:from-amber-700 hover:to-amber-800 text-white text-lg font-semibold rounded-xl disabled:opacity-50"
                      >
                        {isSubmitting ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-stone-300 mb-4">
                      Tu código de descuento <strong className="text-amber-400">BIENVENIDO15</strong> 
