...
const VALUES = [
  ...
  {
    icon: <Rocket className="w-8 h-8 text-[#1e3a8a]" />,
  ...
  return (
    <div className="min-h-screen bg-white">      
      <SEO 
        ...
        description="Conoce la historia de Livo Colombia, expertos en soluciones inteligentes para el hogar. Innovación, calidad y diseño."
        image="https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?w=800&q=80"
        schema={jsonLd}
      />

      {/* Hero Section */}
      <div className="bg-gradient-to-r from-[#1e3a8a] to-[#1e3a8a]/80 text-white py-20">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
            <div className="space-y-6">
              <h2 className="text-3xl font-bold text-gray-900 flex items-center gap-3">
                <Users className="text-[#1e3a8a]" /> Nuestra Historia
              </h2>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto text-center">
            <div className="bg-white p-10 rounded-2xl shadow-sm border border-blue-100">
              <Target className="w-12 h-12 text-[#1e3a8a] mx-auto mb-6" />
            ...
            <div className="bg-white p-10 rounded-2xl shadow-sm border border-blue-100">
              <Heart className="w-12 h-12 text-[#1e3a8a] mx-auto mb-6" />
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {VALUES.map((value, index) => (
              <div key={index} className="text-center p-6 space-y-4">
                <div className="bg-blue-50 w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-4 text-[#1e3a8a]">
                  {value.icon}
                </div>
